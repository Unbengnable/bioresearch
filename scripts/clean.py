...
# 模糊计数映射
FUZZY_COUNT_MAP = {"若干": 27, "很多": 8, "大量": 15}
...
def clean_water(raw_text: str) -> list:
    ...
    date_map = {"5.16": "2026-5.16", "5.23": "2026-5.23", "5.31": "2026-5.31"}
...
if __name__ == "__main__":
    ...
    print("清洗操作摘要：")
    print("  1. 日期标准化 → '2026-5.16' 等标准格式")
    print("  2. 采样点识别 → 匹配 5 个固定地点")
    print("  3. 物种-数量拆分 → 正则分离")
    print("  4. 模糊计数映射 → 若干=27, 很多=8, 大量=15")
